...
const TILES = [
  {
    id: "s3",
    label: "S3 Bucket",
    desc: "Static file hosting and object storage.",
  },
  { id: "ec2", label: "EC2 Instance", desc: "Compute for services and apps." },
  {
    id: "alb",
    label: "Load Balancer",
    desc: "Distribute traffic across instances.",
  },
];
...
export default function AwsCloudSection() {
  ...
  return (
    <FullViewportSection id="aws-cloud" ariaLabel="AWS & Cloud">
      <div className="flex items-center justify-between gap-4">
        <h2 className="text-2xl md:text-3xl font-bold">AWS & Cloud</h2>
        <UnderTheHood text="Animated stepper with timers; interactive tiles with focus/hover states. No external charts or SDKs." />
      </div>
      <div className="mt-6 grid gap-6">
        <Card className="p-5">
          <div className="text-lg font-semibold">
            Simplified Deployment Flow Visualizer
          </div>
          ...
          <div className="mt-5 flex items-center justify-between gap-4">
            ...
            <Button
              className="shrink-0"
              onClick={() => setStep(((step + 1) % 3) as any)}
            >
              Next Step
            </Button>
          </div>
        ...
        <Card className="p-5">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Hover or click a service to learn more.
          </p>
